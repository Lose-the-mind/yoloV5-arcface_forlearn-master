...
if __name__ == '__main__':
    ...
    parser.add_argument('--yoloV5_weights', type=str, default=r'weights/best.pt', help='yolov5.pt path')
    ...
    parser.add_argument('--source', type=str, default='87e3a1110e11e140b421ccc7b6110f78.jpeg', help='source')  # file/folder, 0 for webcam
